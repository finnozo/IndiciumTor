    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
     		...
     		String sql="select * from studentdetails where branch='"+branch+"' and status = -1 and approval=1";
   		 	ResultSet rs=JdbcConnect.selectOperation(sql);
   		 	 		 	
            %>
            
            
            	<center><font color="red"><b>${amsg }</b></font></center><br>
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td><a href="active.jsp?roll=<%=rs.getString("rollnumber")%>&ty=student">
                            GO</a>
                        </td>
                    </tr>
                    <%}%>
                     <tr>
                    <%
                    sql="select * from alumni where branch='"+branch+"' and status = -1 and approval = 1";
                    ...
                    <td >
                        ...
                        <td><a href="active.jsp?roll=<%=rs.getString("mobile")%>&ty=alumni">
                            GO</a>
                        </td>
                    </tr>
                    <%} %>
