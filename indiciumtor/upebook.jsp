...
<script>
  function func()
  {
	 ...
	 a=a.trim();
	  if (a==null || a=="")
	  {
      alert("Enter name of ebook");
      return false;
      }
		 var a=document.forms["f1"]["author"].value;
		 a=a.trim();
		  if (a==null || a=="")
		  {
	      alert("Enter name of author");
	      return false;
	      }
...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Upload E-Book</h1>
				<ol class="breadcrumb">
			...
			<div class="col-lg-12">
				<div class="main" align="center">
					...
					<div class="two" align="center">
						<div class="register" >
							<h3>Fill Details of the Book</h3>
							<form name=f1 id="reg-form1" action="ue" method="post" onsubmit="return func()" enctype="multipart/form-data">
								<div>
								...
								<div>
									<label for="email1">Name</label> <input type="text"
										name="name" id="name" spellcheck="false"
										placeholder="Name of Book" />
								</div>
								<div>
									<label for="username1">Author Name</label> <input type="text"
										name="author" spellcheck="false" placeholder="Author Name" />
								</div>
