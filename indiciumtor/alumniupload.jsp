	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<p align="center"><font  color="red" style="font-size: 2; font-weight: bold;">${ upmsg } </font></p>
			</div>
			<div class="col-lg-12">
				...
				<div id="myTabContent" class="tab-content">
					...
					<div class="tab-pane fade active in" id="service-one">
						...
						<p align="center">	<font color="#e60000">		${ebookmsg}</font></p>
						</form>
					</div>
						...
						<form action="fv" method="post">
							...
							<div class="CSSTableGenerator"
								...
								<table>
									...
									<p align="center"><font color="#e60000">${videomsg}</font></p>
									</form>
							</div>
									   ...
									   <form action="redup" method="post">
										<div class="panel-heading">
											...
											<div align="left" style="padding-left: 60px">
												...
												<font style="font-family: sans-serif;"><b>Choose File Type</b></font><br>
