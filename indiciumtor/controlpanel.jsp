...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <!-- Content Column -->
            <div class="col-md-9">
               <P><h3>As Administrator, you are privileged to control the illegal/untrue access to the website or any false
               content that might be added by any asinine user. Any new request for Login, or content adding will b forwarded 
               to  you first, once you find it authentic/genuine you can approve it and make it available on website.        
                </h3></P>
            </div>
        </div>
        <!-- /.row -->
