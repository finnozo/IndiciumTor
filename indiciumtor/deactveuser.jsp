        ...
        <div class="row">
            ...
            <div class="col-md-9">
             ...
             <%
     		 ...
     		 String sql="select * from login where branch='"+branch+"' and status = 1 and userType='student'";
            ...
            %>
            	...
            	<center><font color="red"><b>${dmsg }</b></font></center><br>
                ...
                <table >
                    <tr>
                      ...
                      <%while(rs.next()){ 
                    	sql ="select * from studentdetails where rollnumber='"+rs.getString("rollnumber")+"'";
                    	ResultSet rsstudent = JdbcConnect.selectOperation(sql);
                    	if(rsstudent.next()){
                    ...
                    <tr>
                        ...
                        <td >
                           <b> <%out.println(rsstudent.getString("fname")+" "+rsstudent.getString("lname"));%></b>
                        </td><% } %>
                        <td>
                            <%out.println(rs.getString("userType")); %>
                        </td>
                        <td><a href="deactive.jsp?roll=<%=rs.getString("rollnumber")%>&ty=student">
                            GO</a>
                        </td>
                    </tr>
                    <%}%>
                     <tr>
                    <%
                    sql="select * from login where branch='"+branch+"' and status = 1 and userType='alumni'";
                    rs=JdbcConnect.selectOperation(sql);
                    while(rs.next()){ 
                    	sql ="select * from alumni where mobile='"+rs.getString("rollnumber")+"'";
                    	ResultSet rsstudent = JdbcConnect.selectOperation(sql);
                    	if(rsstudent.next()){
                    %>
                    <td >
                        ...
                        <td><a href="deactive.jsp?roll=<%=rs.getString("rollnumber")%>&ty=alumni">
                            GO</a>
                        </td>
                    </tr>
                    <%} %>
