...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<!-- Content Column -->
			<div class="col-md-9">
			<form action="deactusr" method="post">
				<%
            	String uid = request.getParameter("roll");
				String type = request.getParameter("ty");
				String sql="";
				if(type.equalsIgnoreCase("student")){
     				sql="select * from studentdetails where rollnumber='"+uid+"'";
				}
				else{
					sql="select * from alumni where mobile='"+uid+"'";
				}
            ...
            %>
				<center>
					<font size="5">Details Description</font>
				</center>
				<div class="CSSTableGenerator">
					<table>
						...
						<tr>
							...
							if(type.equalsIgnoreCase("student")){
			     				%><td><img height="100" width="90" src="imgstudent.jsp?roll=<%=uid%>"></td><%
							}
							else{
								%><td><img height="100" width="90" src="test.jsp?mob=<%=uid%>"></td><%
							}
							%>
						...
						<tr>
							<td>Alumni Name/Student Name</td>
						...
						<tr>
							<td>Type<input type="hidden" name="uid" value="<%= uid %>" />
						...
						<tr>
							...
							<td><input type="radio" name="apr" value="yes" checked="checked"/> YES </td>
						</tr>
