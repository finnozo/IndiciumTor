...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<!-- Content Column -->
			<div class="col-md-9">
			<form action="aprmaga" method="post">
				<%
            int mid = Integer.parseInt(request.getParameter("mid"));							
     		String sql="select * from magazine where id="+mid;
            ...
            %>
				<center>
					<font size="5">Magazine Details</font>
				</center>
				<div class="CSSTableGenerator">
					<table>
						...
						<tr>
							...
							<td><%out.println(rs.getString("reldate")); %></td>
						</tr>
						
						<tr>
							<td>See magazine</td>

							<td><a href="magareader.jsp?id=<%=mid %>" target="_blank">Show Book</a></td>
						</tr>
						
						<tr>
							<td>Approve Status<input type="hidden" name="mid" value="<%= mid %>" /></td>
