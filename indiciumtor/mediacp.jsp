...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            %>
            <center><font size="5">E-Books</font></center>
                ...
                <table >
                    ...
                    <%
                    	while(rs.next()){
                		String sql1 ="select * from ebooks where subject ='"+rs.getString("SID")+"'and status = '"+0+"'";
                		ResultSet rs1=JdbcConnect.selectOperation(sql1);
                		while(rs1.next()){
                			...
                			%>
                					...
                					<tr>
                        				...
                        				<td><a href="mediaapr.jsp?aid=<%=bId %>" >
                            					click Me</a>
                        				</td>
                    				</tr>
