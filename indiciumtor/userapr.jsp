	...
	<div class="container">
		...
		<div class="row">
            ...
            String roll = request.getParameter("roll");							
     		String sql="select * from studentdetails where rollnumber='"+roll+"'";
				...
				<div class="CSSTableGenerator">
					<table>
						...
						<tr>
							...
							<td><img height="100" width="90" src="imgstudent.jsp?roll=<%=roll%>"></td>
						</tr>
						...
						<tr>
							<td>Type<input type="hidden" name="roll" value="<%= roll %>" /></td>
