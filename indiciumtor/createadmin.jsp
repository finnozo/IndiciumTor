...
<title>Control Panel - Super User</title>
...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<!-- Content Column -->
			<div class="col-md-9">
			<center><font size="5">Admin Creation Panel</font></center><br>
				<div align="center">
				<form name="f1" id="contactform" action="createadmin" method="post" onsubmit="return func()">
				<table>
				<tr>
				...
				<tr>
					<td colspan="2" align="center"><br> <input class="buttom" name="submit" id="submit"
						tabindex="9" value="Create Admin" type="submit"></td>
				</tr>
				</table>					
				</form>
			</div>
