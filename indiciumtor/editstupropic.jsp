        ...
        <div class="row">
            ...
            <div class="col-md-9">
               <div align="center" style="margin-top:30px; vertical-align:middle;">
				<form action="upstupropic" method="post" enctype="multipart/form-data" >
			<font color="red" style="font-size: 1em">	${ upmsg }</font>
				<br><br>
                  <img height="100" width="90" src="imgstudent.jsp?roll=<%=roll%>"/>  <br><br> <input style="margin-left: 150px;" type="file" name="picupload" >				
				<br>
