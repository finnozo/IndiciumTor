            ...
            <div class="col-lg-8">
                ...
                <p class="lead">
                 <%
            		...
            		String sql="select * from discussionsection where status="+0+" and postid="+pid;
                ...
                <!-- Comment -->
                <font style="font-family: sans-serif;font-size: 3em;font-weight: bold;">Comments</font>
                  <hr>
                    <%
                   
                      String query="select * from comment where postid="+pid;
                    ...
                    <a class="pull-left" href="#">
                        <img class="media-object" height="64" width="64" src="imgstudent.jsp?roll=<%=rs.getString("rollno") %>" alt="">
                    </a>
