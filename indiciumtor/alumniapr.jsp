...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<!-- Content Column -->
			<div class="col-md-9">
			<form action="apral" method="post">
				<%
            String uid = request.getParameter("uid");							
     		String sql="select * from alumni where mobile='"+uid+"'";
            ...
            %>
				<center>
					<font size="5">Alumni Details</font>
				</center>
				<div class="CSSTableGenerator">
					<table>
						...
						<tr>
							<td>Type<input type="hidden" name="uid" value="<%= uid %>" /></td>
